...
function generate() {
    ...
    //var fontValue = d3.select("#font").property("value")).spiral(d3.select("input[name=spiral]:checked").property("value"));
    //var fontSize = fontSize = d3.scale[d3.select("input[name=scale]:checked").property("value")]().range([10, 100]);
    //var something = tags.length && fontSize.domain([+tags[tags.length - 1].value || 1, +tags[0].value]);
    //var completeValue = 0;
